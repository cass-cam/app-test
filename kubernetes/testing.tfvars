...
# Networking
subnets = ["subnet-0b84ef643ba42be9a", "subnet-0b84ef643ba42be9a", "subnet-00b4a68ee757095fd", "subnet-07585d2ff29ef9e3e", "subnet-0c34cb36ed1e8b6e5", "subnet-0b15470018a42aff1"]
vpc_id  = "vpc-0e6ddd568e06311fc"
...
map_roles = [
  {
    rolearn  = "arn:aws:iam::812066962295:role/adsoft"
    username = "Admins"
...
map_users = [
  {
    userarn  = "arn:aws:iam::812066962295:user/aeciopires"
    username = "aeciopires"
    groups   = ["system:masters"]
  },
]
