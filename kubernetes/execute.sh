...
subpriv1=`aws ec2 describe-subnets --filters "Name=vpc-id,Values=$id" | grep test-app-vpc-private-us-east-1a -B 20 | grep SubnetId | sed 's/^[ \t]*"SubnetId": "//g' | sed 's/",//g'`
subpriv2=`aws ec2 describe-subnets --filters "Name=vpc-id,Values=$id" | grep test-app-vpc-private-us-east-1b -B 20 | grep SubnetId | sed 's/^[ \t]*"SubnetId": "//g' | sed 's/",//g'`
subpriv3=`aws ec2 describe-subnets --filters "Name=vpc-id,Values=$id" | grep test-app-vpc-private-us-east-1c -B 20 | grep SubnetId | sed 's/^[ \t]*"SubnetId": "//g' | sed 's/",//g'`
...
subpub3=`aws ec2 describe-subnets --filters "Name=vpc-id,Values=$id" | grep test-app-vpc-public-us-east-1c -B 20 | grep SubnetId | sed 's/^[ \t]*"SubnetId": "//g' | sed 's/",//g'`
cp eks.tf eks.bk
